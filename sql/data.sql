...
INSERT INTO doctor (doctor_id, department, role, hospital_id, name, password) values (1234567891011, "Dr David Jeremiah", 'Hospital', 'Doctor', 1, '$2b$10$HczQxpCnf.IcZKu8vSp97Oi21f6Oc48XBvkixArHLUNugmMuLFXOy');
INSERT INTO doctor (doctor_id, department, role, hospital_id, name, password) values (5678910111213, "Lovina", 'Clinic', 'Nurse', NULL, '$2b$10$HczQxpCnf.IcZKu8vSp97Oi21f6Oc48XBvkixArHLUNugmMuLFXOy');
INSERT INTO doctor (doctor_id, department, role, hospital_id, name, password) values (3456789101112, "Dr Alice Brown", , 'Hospital', 'Doctor', 2, '$2b$10$HczQxpCnf.IcZKu8vSp97Oi21f6Oc48XBvkixArHLUNugmMuLFXOy');

INSERT INTO hospital (department, role, hospital_id, name, password) values ("Lovina", 'Clinic', 'Nurse', 1, '$2b$10$HczQxpCnf.IcZKu8vSp97Oi21f6Oc48XBvkixArHLUNugmMuLFXOy');
INSERT INTO hospital (department, role, hospital_id, name, password) values ("Dr Alice Brown", , 'Hospital', 'Doctor', 1, '$2b$10$HczQxpCnf.IcZKu8vSp97Oi21f6Oc48XBvkixArHLUNugmMuLFXOy');

INSERT INTO report (patient_id, type, datetime, description, completed) values (78910111213, 'Appointment', new Date(); "Prescription: Medication: Amoxicillin 500mg Directions: Take 1 capsule every 8 hours for 10 days", false);